...
<link href="lib/uploadfile/css/fileinput.css" media="all" rel="stylesheet" type="text/css" />
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        <script src="lib/uploadfile/js/fileinput.js" type="text/javascript"></script>
        <script src="lib/uploadfile/js/fileinput_locale_es.js" type="text/javascript"></script>
  <style>
    body{
      padding-top: 0px;
      padding-bottom: 0px;
