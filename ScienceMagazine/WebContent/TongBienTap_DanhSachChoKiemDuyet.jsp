  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Admin.jsp#"><span class="glyphicon glyphicon-user"></span> Tổng biên tập</a></li>
         ...
         <fieldset>
          ...
          <div class="tab-content">
            ...
            <br>
              <div class="col-sm-8">
              <ul class="list-group">
                <li class="list-group-item"><a href="GiaoBaiChoPhanBien.jsp">Iphone 7 ra mắt vào ngày 09/09/2016 </a>
