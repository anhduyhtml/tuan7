  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Admin.jsp#"><span class="glyphicon glyphicon-user"></span> Biên tập viên</a></li>
...
<div class="container-fluid text-center">
  <div class="row content">
          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="BaiVietSua_BTV.jsp">Bài viết được giao chỉnh sửa</a></li>
             </ul>
            </nav>
     </ul>
    </div>
    <div class="col-sm-8 text-left">
        <form>
         <fieldset>
          <legend><label><font color="red">Trang Của Tôi</font></label></legend>
          <div class="container">
          <ul class="nav nav-pills">
            <li class="active"><a data-toggle="pill" href="#menu1">BÀI CHƯA SỬA</a></li>
            <li><a data-toggle="pill" href="#menu2">BÀI ĐÃ SỬA</a></li>
          </ul>
          <div class="tab-content">
            ...
            <br>
              <div class="col-sm-8">
              <ul class="list-group">
                <li class="list-group-item"><a href="SuaBai_BTV.jsp">Iphone 7 ra mắt vào ngày 09/09/2016 </a>
