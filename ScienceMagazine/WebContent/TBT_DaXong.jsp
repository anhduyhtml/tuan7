        ...
        <tr>
          <td>
            <form class="form-horizontal">
              ...
              <br>
              <div class="col-sm-4"><button type="submit" class="btn btn-success btn-block">Gửi lại cho BTV</button></div>
              <div class="col-sm-4"><button type="submit" class="btn btn-success btn-block">Đăng bài viết</button></div>              
            </form>
          </td>
          <td>
            </form>
